...
def export_to_csv(df: pd.DataFrame, columns: list, include_summary: bool, include_insights: bool) -> bytes:
    """
    Export selected columns to CSV, optionally prepending summary metrics and auto‑generated insights.
...
def export_to_pdf(df: pd.DataFrame, columns: list, include_summary: bool, include_insights: bool) -> bytes:
    ...
    The report includes a summary section (with metrics and auto‑generated insights) and a Data Report section.
    """
    try:
        import pdfkit
    except ImportError:
