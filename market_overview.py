...
def market_overview_dashboard(data: pd.DataFrame):
    ...
    # Verify that data exists and required columns are present
...
with tab1:
    ...
    with tab3:
        ...
        fig3 = px.line(monthly_trends, x="Month", y="Tons", title="Monthly Import Trends", markers=True)
        st.plotly_chart(fig3, use_container_width=True)
        
        # If multiple years are present, add a year-wise breakdown
    ...
    with tab5:
        ...
        fig6 = px.line(period_totals, x="Period", y="Tons", title="Import Trend by Period", markers=True)
